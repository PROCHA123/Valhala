...
public class Drive extends SubsystemBase {
  ...
  public void mainDrive(double xInSpeed, double yInSpeed, double inDirectThrottle, boolean inDirection){
    ...
    if(xSpeed>=0){
      leftPwm =  (ySpeed+xSpeed)*Constants.kDriveSensitivity; //sensibilidad del control agregada
      rightPwm = (ySpeed-xSpeed)*Constants.kDriveSensitivity;
    }
    
    else{
      leftPwm =  (ySpeed+xSpeed)*Constants.kDriveSensitivity;
      rightPwm = (ySpeed-xSpeed)*Constants.kDriveSensitivity;
    }
  ...
  private void outMotores(){
    mMotor1FrontRight.set(ControlMode.PercentOutput, final_right_front_demand*0.6);
    mMotor2BackRight.set(ControlMode.PercentOutput, final_right_back_demand*0.6);
